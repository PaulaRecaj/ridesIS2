...
public class GauzatuEragiketaBDWhiteTest {
	 ...
	 * 
	 * 
	 * @Test //the user does not withdraw all the money from his account leaving its
	 * balance >0 public void test3() {
	 * 
	 ...
	 * fail(); }finally {
	 * 
	 * deposit=true; sut.gauzatuEragiketa(username, amount, deposit); sut.close();
	 * 
	 * }
	 * 
	 * }
	 * 
	 * 
	 * @Test //the user does withdraws all the money from his account leaving its
	 * balance 0 public void test4() {
	 * 
	 ...
	 * fail(); }finally {
	 * 
	 * deposit=false; sut.gauzatuEragiketa(username, amount, deposit); sut.close();
	 * 
	 * }
	 * 
	 * }
