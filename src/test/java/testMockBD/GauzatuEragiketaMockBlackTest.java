...
public class GauzatuEragiketaMockBlackTest {
	 ...
	 *//**
		 ...
		 *//*
			 ...
			 * 
			 * username="Unax"; amount=0.00; double amount2 = -10.00; deposit= true;
			 * 
			 * User u = new User(username, "123456", "driver"); //u.setMoney(100.00);
			 * 
			 * 
			 * 
			 * try {
			 ...
			 * username)).thenReturn(tq); Mockito.when(tq.getSingleResult()).thenReturn(u);
			 * 
			 * 
			 * 
			 * sut.open();
			 ...
			 * try {
			 * 
			 * Mockito.when(db.createQuery("SELECT u from User WHERE u.username = :username"
			 * , User.class)).thenReturn(tq);
			 * Mockito.when(tq.getSingleResult()).thenReturn(null);
			 * 
			 * op= sut.gauzatuEragiketa(username, amount, deposit);
			 ...
			 * 
			 * User u = new User(username, "mypass", "driver"); //u.setMoney(100.00);
			 * 
			 * 
			 * try {
			 * 
