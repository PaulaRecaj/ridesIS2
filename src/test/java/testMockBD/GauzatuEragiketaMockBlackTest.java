    ...
    public  void tearDown() {
	 ...
	 public void test1() {
		 ...
		 try {
			 ...
			 Mockito.when(db.createQuery("SELECT u from User u WHERE u.username = :username", User.class)).thenReturn(tq);
	 ...
	 /**amount=0 and amount<0 (debería de devolver false, pero como el método gauzatuEragiketa no comprueba
		 * si amount es igual a 0 o menor que 0, devuelve true y por eso falla )
		 */
		 @Test
		 public void test2() {
		...
		//the user does not exist in the database
		 ...
		 //the user exists in the database, the method should go perfectly and return true
